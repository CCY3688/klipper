param(
    ...
    [string]$RemotePath = "/home/umeko/fluidd",
    [string]$LocalBackup = "D:\ccy\Desktop\host\backups\board_192.168.67.182\20260620_klipperscreen_gui_backup\fluidd",
...
Write-Host "This will restore fluidd from local backup to $BoardUser@$BoardHost`:$RemotePath"
