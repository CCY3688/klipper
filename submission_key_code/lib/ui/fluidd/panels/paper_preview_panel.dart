...
class _PaperPreviewPanelState extends State<PaperPreviewPanel>
  ...
  void _toggleDynamicPreview() {
    ...
    setState(() {
      ...
      if (_isDynamicPreview) {
        ...
        final totalPoints = _uploadedToolPath.polylines.fold(
          0,
  ...
  Widget build(BuildContext context) {
    ...
    return FluiddCard(
        ...
        IconButton(
          ...
          icon: Icon(
            ...
            color: _isDynamicPreview
                ? Colors.orange
                : (_uploadedToolPath.polylines.isEmpty
                      ? Colors.grey.shade600
                      : Colors.grey),
            size: 20,
          ),
          onPressed: _uploadedToolPath.polylines.isEmpty
              ? null
              : _toggleDynamicPreview,
        ),
        if (_isDynamicPreview)
          Padding(
      ...
      child: AspectRatio(
        aspectRatio:
            paperConfig.pageWidthMm / paperConfig.pageHeightMm, // 保持纸张比例
        child: Container(
