...
class StrokeFont {
  ...
  /// Merge multiple stroke fonts. Later fonts override earlier duplicate chars.
  factory StrokeFont.merge(Iterable<StrokeFont> fonts) {
    final merged = <String, Glyph>{};
    for (final font in fonts) {
      for (final ch in font.characters) {
