...
class _ConsolePanelState extends State<ConsolePanel> {
  ...
  Color _logColor(BuildContext context, LogLevel level) {
    ...
    switch (level) {
      ...
      case LogLevel.info: return Colors.white;
    ...
    return FluiddCard(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () { 
            // TODO: Clear logs implementation if needed
          },
                ...
                return Padding(
                  ...
                  child: SelectableText.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text: '[${entry.ts.hour.toString().padLeft(2, '0')}:${entry.ts.minute.toString().padLeft(2, '0')}:${entry.ts.second.toString().padLeft(2, '0')}] ',
                        ...
                        TextSpan(
                          text: entry.msg,
                          style: TextStyle(color: _logColor(context, entry.level), fontSize: 13, fontFamily: 'monospace'),
                        ),
                      ],
                    ),
                  ),
            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(color: Colors.white), // Force white text for dark theme
