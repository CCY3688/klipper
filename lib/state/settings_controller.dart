...
class SettingsController extends ChangeNotifier {
  ...
  // ── 公开 setter（改完自动持久化）──────────────────────────────────────
  void setXySpeed(double v)        { xySpeed = v;        notifyListeners(); _save(); }
  void setZSpeed(double v)         { zSpeed  = v;        notifyListeners(); _save(); }
  void setInvertX(bool v)          { invertX = v;        notifyListeners(); _save(); }
  void setInvertY(bool v)          { invertY = v;        notifyListeners(); _save(); }
  void setInvertZ(bool v)          { invertZ = v;        notifyListeners(); _save(); }
  void setPenDownZ(double v)       { penDownZ = v;       notifyListeners(); _save(); }
  void setPenUpZ(double v)         { penUpZ = v;         notifyListeners(); _save(); }
  void setWriteSpeed(double v)     { writeSpeed = v;     notifyListeners(); _save(); }
  void setConfirmOnEstop(bool v)   { confirmOnEstop = v; notifyListeners(); _save(); }
}
